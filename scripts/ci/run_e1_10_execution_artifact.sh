...
#
# Usage:   bash scripts/ci/run_e1_10_execution_artifact.sh [REPO_ROOT]
...
AUX_FILES=(
  ...
  "reports/e1_10_smoke/e1_10_a_optimism_cases.csv"
  "reports/e1_10_smoke/e1_10_a_optimism_verdict.csv"
...
OUT="audit_artifacts/e1_10_${STAMP}"
mkdir -p "$OUT"
