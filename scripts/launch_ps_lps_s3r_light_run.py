#!/usr/bin/env python3
"""Failure-isolated launcher for PS-LPS S3R-light runs."""
...
def main() -> int:
    ...
    parser.add_argument("--task_timeout_sec", type=float, default=7200.0)
    ...
    worker = pathlib.Path(
        ...
        "run_ps_lps_s3r_light_task.R"
    )
    merge = pathlib.Path(
        "/Users/pgajer/current_projects/geosmooth/scripts/"
        "merge_ps_lps_s3r_light_run.R"
    )
