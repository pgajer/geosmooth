...
#
# Run:    Rscript validation/e2_14_prefix_newton_overshoot.R
# Output: reports/e2_14_prefix_newton_overshoot.csv (per-iteration deviance
...
utils::write.csv(
    ...
    "reports/e2_14_prefix_newton_overshoot.csv",
    row.names = FALSE
)
cat("wrote reports/e2_14_prefix_newton_overshoot.csv\n")
