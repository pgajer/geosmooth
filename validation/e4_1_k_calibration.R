...
#
# Usage:  Rscript validation/e4_1_k_calibration.R [key=value ...]
#         keys: K.grid (comma-separated), sigma, level, target.ratio, out.dir
# =============================================================================

suppressMessages(pkgload::load_all(".", quiet = TRUE))
source("validation/e4_1_coverage_study.R")   # helpers; CLI is sys.nframe()-guarded
source("validation/e4_1_g3a_binding.R")
...
run.e4.1.k.calibration <- function(
    ...
    level = 0.95,
    target.ratio = 0.3,
    out.dir = file.path("audit_artifacts",
