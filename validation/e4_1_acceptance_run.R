...
#
# Usage: Rscript validation/e4_1_acceptance_run.R [out.dir=...] [fit.every.replicate=TRUE]
# =============================================================================

source("validation/e4_1_k_calibration.R")  # loads package + study + binding (CLI-guarded)
