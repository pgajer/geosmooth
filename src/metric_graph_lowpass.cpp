...
// [[Rcpp::export]]
SEXP rcpp_metric_graph_lowpass_operator(
    SEXP s_adj_list,
    SEXP s_weight_list,
    SEXP s_conductance_rule,
    SEXP s_conductance_epsilon,
    ...
    return S_metric_graph_lowpass_operator(
        s_adj_list,
        s_weight_list,
        s_conductance_rule,
        s_conductance_epsilon,
        s_conductance_alpha,
        s_conductance_sigma,
        s_sigma_rule,
        s_sigma_quantile,
...
// [[Rcpp::export]]
SEXP rcpp_metric_graph_lowpass_spectrum(
    SEXP s_adj_list,
    SEXP s_weight_list,
    SEXP s_conductance_rule,
    SEXP s_conductance_epsilon,
    ...
    return S_metric_graph_lowpass_spectrum(
        s_adj_list,
        s_weight_list,
        s_conductance_rule,
        s_conductance_epsilon,
        ...
        s_n_eigenpairs,
        s_eigen_solver,
        s_dense_eigen_threshold,
        s_dense_fallback_threshold,
        s_dense_fallback,
        s_verbose
    );
}
