...
# (project_briefs/lps_g4_ridge_resolution_2026-06-12.md): the aligned ridge
...
#       validation/e2_13_pin_reference_fits.R into
#       reports/e2_13_reference_fits.csv). This is the pin that protects
#       Tier-0 and E1.9.
#
...
test_that("E2.13 S A2: the default path reproduces pre-change fits bit-for-bit", {
    # Reference values were generated by validation/e2_13_pin_reference_fits.R
    ...
    ref <- utils::read.csv("../../reports/e2_13_reference_fits.csv",
