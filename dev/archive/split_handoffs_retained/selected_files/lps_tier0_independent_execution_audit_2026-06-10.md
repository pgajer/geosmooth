...
6. The harness does not produce `gate_contexts.txt`.
   ...
   created `dev/methods/lps/audit_artifacts/tier0_20260610T195855Z/` and correctly marked:
...
From the dirty-tree harness probe bundle `dev/methods/lps/audit_artifacts/tier0_20260610T195855Z/`:
...
The only generated bundle in this audit, `dev/methods/lps/audit_artifacts/tier0_20260610T195855Z/`, is invalid by construction and by content:
