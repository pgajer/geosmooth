...
# Reference file: dev/methods/lps/runs/tier2/e2_13_reference_fits.csv (committed).
#
# Run from the package root:
#   Rscript dev/methods/lps/ci/e2_13_pin_reference_fits.R
...
dir.create("dev/methods/lps/runs/tier2", recursive = TRUE, showWarnings = FALSE)
utils::write.csv(rows, "dev/methods/lps/runs/tier2/e2_13_reference_fits.csv",
                 row.names = FALSE)
cat("wrote dev/methods/lps/runs/tier2/e2_13_reference_fits.csv at commit", git.head, "\n")
