...
# (dev/methods/lps/ci/run_tier0_execution_artifact.sh): produces a self-contained,
...
#
# Usage:   bash dev/methods/lps/ci/run_e1_9_execution_artifact.sh [REPO_ROOT]
...
SRC_FILE="R/lps.R"
PROBE="dev/methods/lps/ci/e1_9_realized_quantities_probe.R"
PIN_SCRIPT="dev/methods/lps/ci/e1_9_pin_reference_fits.R"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
OUT="dev/methods/lps/audit_artifacts/e1_9_${STAMP}"
mkdir -p "$OUT"
