...
#
# Run:    Rscript dev/methods/lps/ci/e2_12_crossclip_stability_study.R
# Output: dev/methods/lps/runs/tier2/e2_12_crossclip_scores.csv   (per candidate x clip)
#         dev/methods/lps/runs/tier2/e2_12_crossclip_stability_verdict.csv (one row)
...
utils::write.csv(scores, "dev/methods/lps/runs/tier2/e2_12_crossclip_scores.csv",
                 row.names = FALSE)
...
utils::write.csv(verdict, "dev/methods/lps/runs/tier2/e2_12_crossclip_stability_verdict.csv",
                 row.names = FALSE)
...
cat("wrote dev/methods/lps/runs/tier2/e2_12_crossclip_scores.csv and dev/methods/lps/runs/tier2/e2_12_crossclip_stability_verdict.csv\n")
