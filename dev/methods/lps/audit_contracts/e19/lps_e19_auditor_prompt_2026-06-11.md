...
- Frozen spec (authoritative gate definitions): `dev/methods/lps/specs/lps_experimental_plan_2026-06-09.tex`
...
- *"Add E1.9 implementer handoff"* → `dev/methods/lps/handoffs/phase/e1_9_implementer_handoff_2026-06-11.md` (read as
  evidence + admissions only).

Also read `audit_contracts/tiers1to4/e1_9_spec_questions_implementer_2026-06-11.md` (the
