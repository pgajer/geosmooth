...
- Frozen spec (§E4.1; and §sec:smoother for the S-extraction protocol): `/Users/pgajer/current_projects/geosmooth/dev/methods/lps/specs/lps_experimental_plan_2026-06-09.tex`
...
Deliverables: the code; `testthat` GATE(s) and/or `validation/` STUDY scripts + `reports/`; and a handoff at `dev/methods/lps/handoffs/phase/e4_1_implementer_handoff_<date>.md` that is **facts and admissions only**, with a mandatory **"Limitations and unverified claims"** section. No audit questions, no suggested verdict, no "what to inspect" checklist.
