...
- Frozen spec — **§sec:dgp** (the exact G1–G7 definitions you must match) and §sec:rng / §sec:tol (conventions): `/Users/pgajer/current_projects/geosmooth/dev/methods/lps/specs/lps_experimental_plan_2026-06-09.tex`
