...
writing to `dev/methods/lps/audit_artifacts/<gate>_<UTC>/`. After each gate's source change I
...
statistical). Handoffs at `dev/methods/lps/handoffs/phase/<gate>_implementer_handoff_<date>.md`,
