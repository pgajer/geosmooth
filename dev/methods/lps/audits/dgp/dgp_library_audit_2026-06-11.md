...
This assignment has no Tier-0-style `dev/methods/lps/audit_artifacts/` execution bundle. The
...
git rev-parse HEAD
git status --short
git show codex/geosmooth-e1-9-bandwidth-multiplier:dev/methods/lps/specs/lps_experimental_plan_2026-06-09.tex > /tmp/plan.tex
