...
`dev/methods/lps/audit_artifacts/tier2_20260612T233509Z/` and an update to
`dev/methods/lps/handoffs/phase/e0_6_binomial_amendment_handoff_2026-06-12.md`; no package
...
- Full-size bundle `dev/methods/lps/audit_artifacts/tier2_20260612T233509Z/`.
...
- Bundle `dev/methods/lps/audit_artifacts/tier2_20260612T233509Z` records git head
