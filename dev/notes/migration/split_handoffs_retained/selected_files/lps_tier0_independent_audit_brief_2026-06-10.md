...
- Frozen gate spec (authoritative): `project_briefs/lps_experimental_plan_2026-06-09.tex`, sections E0.1–E0.8.
...
Audit the newest `audit_artifacts/tier0_<stamp>/` against the contract (§4), independently:
...
- Do not reuse the implementer's earlier local bundle (`audit_artifacts/tier0_20260610T184844Z`, `tree_clean:false`) — generate your own.
